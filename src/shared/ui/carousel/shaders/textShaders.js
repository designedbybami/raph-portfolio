...
//
// At uReveal 0 the sample sits a full cell below the mask and every fragment is discarded, so the character is genuinely absent rather than transparent. At 1 it lines up exactly with the quad.
